...
Route::middleware('auth')->group(function () {
    // Legacy "operations" pages: dashboard, orders, reception, tracking.
    Route::middleware('role:admin,reception,pepe,ale,luis,luisc,hugo,anthony')->group(function () {
    ...
    Route::middleware('role:admin,technician,repairer,pepe,ale,luis,martin,luis1c,luisc,hugo,jefe,anthony')->group(function () {
    ...
    // QC workspace access.
    Route::middleware('role:admin,qc,qcagent,repairer,pepe,ale,luis,martin,luis1c,luisc,hugo,jefe,anthony')->group(function () {
    ...
    // Admin-only tools.
    Route::middleware('role:admin,pepe,ale,luis')->group(function () {
