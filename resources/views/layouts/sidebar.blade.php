...
<aside class="app-sidebar" id="appSidebar">
    ...
    <nav class="app-nav">
        ...
        @if ($isAdmin)
            <a class="app-nav__link {{ $currentRoute === 'admin.companies' ? 'is-active' : '' }}"
                href="{{ route('admin.companies') }}" title="Companies & Modules">
                <i class="bi bi-building"></i>
                <span>Companies & Modules</span>
            </a>
            <a class="app-nav__link {{ $currentRoute === 'admin.index' ? 'is-active' : '' }}"
                href="{{ route('admin.index') }}" title="Administrator">
